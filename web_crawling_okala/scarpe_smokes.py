...
collection = get_collection("smokes")
...
driver.get("https://www.okala.com/store/8875/browse/tobacco?rootId=3010")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش دخانیات در دیتابیس ذخیره شد.")
