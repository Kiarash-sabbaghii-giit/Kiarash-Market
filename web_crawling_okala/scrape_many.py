...
driver.get("https://www.okala.com/store/8875/browse/multiples?rootId=1850")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش چندتایی در دیتابیس ذخیره شد.")
    ...
    print("❌ هیچ محصولی پیدا نشد. احتمالاً صفحه خالی است یا ساختار متفاوتی دارد.")