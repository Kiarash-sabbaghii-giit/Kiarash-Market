...
collection = get_collection("home_hygiene")
...
driver.get("https://www.okala.com/store/8875/browse/home-hygiene?rootId=1471")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش نظافت منزل در دیتابیس ذخیره شد.")
