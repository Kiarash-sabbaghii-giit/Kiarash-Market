...
collection = get_collection("breakfast")
...
driver.get("https://www.okala.com/store/8875/browse/breakfast-goods?rootId=1466")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش صبحانه در دیتابیس ذخیره شد.")
