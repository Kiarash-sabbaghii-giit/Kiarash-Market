...
collection = get_collection("cosmetics")
...
driver.get("https://www.okala.com/store/8875/browse/cosmetics-hygiene?rootId=1472")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش آرایشی و بهداشتی در دیتابیس ذخیره شد.")
