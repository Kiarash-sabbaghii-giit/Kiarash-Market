...
collection = get_collection("spices")
...
driver.get("https://www.okala.com/store/8875/browse/spices?rootId=1469")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش ادویه و چاشنی در دیتابیس ذخیره شد.")
