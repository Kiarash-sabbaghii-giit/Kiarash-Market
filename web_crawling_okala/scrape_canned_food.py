...
collection = get_collection("canned_food")
...
driver.get("https://www.okala.com/store/8875/browse/canned-ready-food?rootId=1464")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش کنسرو و انواع غذا در دیتابیس ذخیره شد.")
