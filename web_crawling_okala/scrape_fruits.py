...
collection = get_collection("fruits")
...
driver.get("https://www.okala.com/store/8875/browse/fruits-vegetables?rootId=1470")
time.sleep(5)
...
if products:
    ...
    print(f"\n🎉 {len(products)} محصول از بخش میوه و سبزیجات در دیتابیس ذخیره شد.")
